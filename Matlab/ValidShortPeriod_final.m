...
t           = 0:(data.flightdata.Gps_utcSec.data(ending)-data.flightdata.Gps_utcSec.data(begin))/(ending-begin):(data.flightdata.Gps_utcSec.data(ending)-data.flightdata.Gps_utcSec.data(begin));
sys         = ss(A, B, C, D);
SP          = lsim(sys, u, t);
